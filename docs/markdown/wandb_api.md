...
### Api.reports
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L320)
```python
...
### Api.runs
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L347)
```python
...
### Api.run
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L392)
```python
Api.run(self, path='')
```
...
### Api.sweep
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L409)
```python
Api.sweep(self, path='')
```
...
### Api.artifact
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L437)
```python
...
## Projects
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L557)
```python
...
## Project
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L613)
```python
...
## Runs
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L634)
```python
...
## Run
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L719)
```python
...
### Run.update
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L883)
```python
Run.update(self)
```
...
### Run.files
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L942)
```python
...
### Run.history
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L965)
```python
Run.history(self,
            samples=500,
            keys=None,
...
## Sweep
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1076)
```python
...
## Files
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1217)
```python
...
## File
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1273)
```python
...
### File.download
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1324)
```python
...
## QueryGenerator
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1420)
```python
QueryGenerator(self)
```
...
## BetaReport
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1519)
```python
...
## ArtifactType
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1882)
```python
...
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1926)
```python
